...
public class TestFileSystem {
	...
	public void testGetPacketNumber() {
		...
		assertEquals(13411, test.testgetPacketNumber(data1));
		assertEquals(41251, test.testgetPacketNumber(data2));
	...
	public void testAssembleData() {
		...
		solution.add(file2data);
		solution.add(file3data);
		assertEquals(solution, test.testassembleFiles(data, files));
	}
	...
	// Header Packets <statusbyte> 1 byte, <fileID> 1 byte, <filename> rest of bytes
		...
		TestPacket f3 = new TestPacket(f3Data);
		// h1, f1 data packets
		byte[] data1 = {(byte)0x05, (byte)0x35, (byte)0x00, (byte)0x00, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data2 = {(byte)0x05, (byte)0x35, (byte)0x00, (byte)0x01, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data3 = {(byte)0x05, (byte)0x35, (byte)0x00, (byte)0x02, (byte)0x13, (byte)0x14, (byte)0x15};
		TestPacket d1 = new TestPacket(data1);
		TestPacket d2 = new TestPacket(data2);
		TestPacket d3 = new TestPacket(data3);
		// h2, f2 data packets
		byte[] data4 = {(byte)0x05, (byte)0x34, (byte)0x00, (byte)0x00, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data5 = {(byte)0x05, (byte)0x34, (byte)0x00, (byte)0x01, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data6 = {(byte)0x05, (byte)0x34, (byte)0x00, (byte)0x02, (byte)0x13, (byte)0x14, (byte)0x15};
		TestPacket d4 = new TestPacket(data4);
		TestPacket d5 = new TestPacket(data5);
		TestPacket d6 = new TestPacket(data6);
		// h3, f3 data packets
		byte[] data7 = {(byte)0x05, (byte)0x33, (byte)0x00, (byte)0x00, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data8 = {(byte)0x05, (byte)0x33, (byte)0x00, (byte)0x01, (byte)0x13, (byte)0x14, (byte)0x15};
		byte[] data9 = {(byte)0x05, (byte)0x33, (byte)0x00, (byte)0x02, (byte)0x13, (byte)0x14, (byte)0x15};
		TestPacket d7 = new TestPacket(data7);
		TestPacket d8 = new TestPacket(data8);
		TestPacket d9 = new TestPacket(data9);
		...
		ArrayList<TestPacket> solution = new ArrayList<>();
		solution.add(f1);
		solution.add(f2);
		solution.add(f3);
		// file 1 data
		...
		test.testfilterData(data);
		assertEquals(solution, data);
	}
}
